...
public class Program01 {
	...
	public static void main(String[] args) throws ParseException {
		...
		Worker worker = new Worker(workerName, WorkerLevel.valueOf(workerLevel), workerSalary, new Department(departamentName));
		...
		for (int i = 1; i <= quantityContracts; i++) {
			...
			HourContract contract = new HourContract(contractDate, valuePerHour, durationContract);
